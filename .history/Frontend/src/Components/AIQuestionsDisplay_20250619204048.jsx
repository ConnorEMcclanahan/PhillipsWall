                        ...
                        {clusterAnswers.map((answer, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        position: 'absolute',
                                        width: isFocused ? '700px' : '500px', // EVEN WIDER cards
                                        height: isFocused ? '600px' : '500px', // TALLER cards
                                        backgroundColor: questionColor,
                                        borderRadius: '8px', // REDUCED radius for more post-it look
                                        boxShadow: isFocused
                                        ...
                                        transform: isFocused
                                            ? 'translateY(-200px) translateX(0) rotate(0deg) scale(1.1)' // Move higher
                                            : `translateX(${angle * 40}px) translateY(${isHovered ? -40 : 0}px) rotate(${angle}deg)`,
                                ...
                                >
                                    ...
                                    <div style={{
                                        ...
                                        display: 'flex',
                                        flexDirection: 'column',
                                        padding: '35px 40px 30px', // MORE padding for better readability
                                    }}>
                                        {/* Smaller thumbtack */}
                                        <div style={{
                                            position: 'absolute',
                                        ...
                                        <div style={{
                                            fontSize: isFocused ? '24px' : '20px', // LARGER text
                                            fontWeight: 'bold',
                                            color: '#000',
                                            textAlign: 'center',
                                            marginBottom: '25px', // MORE space below question
                                            paddingBottom: '15px', // Add padding
                                            borderBottom: '1px solid rgba(0,0,0,0.1)', // Subtle separator
                                        }}>
                                            {questionText}
                                        </div>
                                        ...
                                        <div style={{
                                            color: '#000',
                                            fontSize: isFocused ? '20px' : '18px', // LARGER text
                                            lineHeight: '1.6', // INCREASED line height
                                            textAlign: 'left',
                                            overflow: 'auto', // Allow scrolling for very long answers
                                            flex: 1,
                                            paddingRight: '10px',
                                        }}>
                                            {answerText.split('\n').map((line, i) => (
                                                <div key={i} style={{ 
                                                    marginBottom: '12px', // More space between paragraphs
