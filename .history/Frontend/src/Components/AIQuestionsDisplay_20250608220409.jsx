    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.timeline} style={{
                ...
                position: 'relative', // Needed for line clipping
            }}>
                {/* Instead of adding a new line, let's create a wrapper to contain the existing line */}
                <div style={{
                    position: 'absolute',
                    left: '4%', // Trim from left
                    right: '4%', // Trim from right
                    top: 0,
                    bottom: 0,
                    overflow: 'hidden', // This will clip the line
                    zIndex: 1,
                }}>
                    {/* This empty div takes up space but clips the timeline line */}
                </div>
                ...
                {SEASONS.map((season, index) => (
                    <div
                        ...
                        style={{ zIndex: 2 }} // Make sure dots and text appear above clipping
                    >
                        <div 
                            className={`
