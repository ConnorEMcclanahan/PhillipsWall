...
const AIQuestionsDisplay = () => {
    ...
    useEffect(() => {
        ...
        const updateBubblePositions = () => {
            const styles = clusteredAnswers.map((cluster) => {
                // Use the first answer's position for stability
                ...
                // Keeping the console.log from the up-to-date version for debugging
                ...
                const baseSize = 10;
                const maxSize = 150;
                const size = cluster.size === 1 ? baseSize : Math.min(maxSize, baseSize + (cluster.size - 1) * 8);
        ...
        // Keeping the interval from the up-to-date version
    ...
    // Adding the renderExpandedCluster function from your feature branch
