    ...
    const renderExpandedCluster = () => {
        ...
        return (
            <>
                ...
                {/* Card hand at bottom - now with questions on each card */}
                <div style={{
                    position: 'fixed',
                    bottom: '5%',
                    left: '50%',
                    ...
                    <div style={{
                        ...
                        {clusterAnswers.map((answer, index) => {
                            ...
                            const maxAngle = Math.min(60, totalCards * 4);
                            ...
                            const answerPreview = answerText.length > 40 ? 
                                answerText.slice(0, 40) + "..." : 
                                answerText;
                            ...
                            return (
                                <div
                                    ...
                                    title={answerPreview}
                                >
                                    {/* Card content with question and preview */}
                                    <div style={{
                                        position: 'relative',
                                        width: '100%',
                                        height: '100%',
