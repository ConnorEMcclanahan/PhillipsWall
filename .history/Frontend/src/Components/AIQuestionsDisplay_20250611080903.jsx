...
const AIQuestionsDisplay = () => {
    ...
    const renderExpandedCluster = () => {
        ...
        const radius = 400; // Increased radius to spread cards out more (was 300)
        ...
        return (
            <>
                ...
                {/* Answer cards - redesigned with "hole in middle" effect */}
                <div className={styles.expandedCluster}>
                    {clusterAnswers.map((answer, index) => {
                        ...
                        return (
                            ...
                            >
                                {/* Box with hole in middle design */}
                                <div style={{
                                    width: '90%',
                                    height: '90%',
                                    margin: '10px',
