    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.timeline} style={{
                ...
                transition: 'opacity 0.3s ease',
                pointerEvents: expandedCluster ? 'none' : 'auto',
                transform: 'scale(0.8)',         // Scale the entire timeline to 80%
                transformOrigin: 'center bottom', // Scale from the bottom center
                margin: '0 auto 20px auto',     // Added 20px bottom margin to raise it up
                position: 'relative',           // Ensure positioning works
                bottom: '15px',                 // Move up from bottom by 15px
            }}>
