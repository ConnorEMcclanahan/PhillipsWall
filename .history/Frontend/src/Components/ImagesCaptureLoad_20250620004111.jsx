...
const ImagesCaptureLoad = () => {
        ...
        return (
            <Box 
                ...
                sx={{
                    ...
                    position: 'absolute',
                    right: '20px',
                    top: '22px', // Aligns with the title
                    borderRadius: '20px',
                    overflow: 'hidden',
    ...
    const renderScanningInfo = () => {
        ...
        const handleLanguageToggle = (newLang) => {
            // Use the existing language context to change language
            if (setLanguage) {
                setLanguage(newLang);
            }
        };
                ...
                <Box className={styles.successContainer}>
                    ...
                    <Box className={styles.scannedPostItContainer}>
                        <Box 
                            ...
                            style={{ 
                                // Always use the question color map for consistency
                                backgroundColor: questionColorMap[modelResult.question_id] || '#FFA500' // Orange fallback
                            }}
                        >
                    ...
                    <Box className={styles.successMessageContainer}>
                        ...
                        <Typography className={styles.successSubmessage}>
                            {hasValidText 
                                ? "Your note has been successfully scanned. Check it on the wall!"
                                : "Please type your message below to add it to the wall."
                            }
                        </Typography>
