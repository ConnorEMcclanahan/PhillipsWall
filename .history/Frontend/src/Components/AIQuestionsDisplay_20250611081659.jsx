...
const AIQuestionsDisplay = () => {
    ...
    const renderExpandedCluster = () => {
        ...
        const radius = 350; // Reduced radius to bring cards closer (was 400)
        ...
        return (
            <>
                ...
                {/* Central question - slightly larger size */}
                <div
                ...
                {/* Answer cards - with thumb tack hole look */}
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    minHeight: '180px',
                                    padding: '0',
                                    borderRadius: '2px', // Reduced for more square look
                                    zIndex: 20,
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    position: 'relative',
                                    zIndex: 2,
                                    margin: '20px 10px 10px 10px', // Extra top margin for the hole
                                    padding: '5px',
                                }}>
                                    {answerText.split('\n').map((line, i) => (
                                        <div key={i} style={{ 
