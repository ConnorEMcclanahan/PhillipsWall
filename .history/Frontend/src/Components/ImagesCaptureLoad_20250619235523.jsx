                ...
                <Box className={styles.successContainer}>
                    ...
                    <Box className={styles.scannedPostItContainer}>
                        <Box 
                            ...
                            style={{ 
                                // Force a specific color here to override any detection issues
                                // You can change this fixed color or use a mapping based on question_id
                                backgroundColor: getQuestionColor(modelResult.question_id)
                            }}
                        >
