...
const AIQuestionsDisplay = () => {
    ...
    // Modified handleBubbleClick to work with clusters
    const handleBubbleClick = async (answerId, questionId, event) => {
        ...
        try {
            ...
            setTimeout(() => {
                ...
                setActiveQuestionData(data);
                setCurrentPage(1);
                setExpandedCluster(null); // Close any expanded cluster
            }, TRANSITION_DURATION / 2);
        } catch (error) {
            console.error("Error fetching question details:", error);
        }
    ...
    // Update the renderExpandedCluster function
        ...
        return (
            <>
                ...
                <div 
                    ...
                    onClick={() => setExpandedCluster(null)}  // Close when clicking outside
                    style={{
                        position: 'fixed',
                        top: 0,
                        left: 0,
                ...
                {/* Original cluster indicator */}
                <div 
                    className={styles.originalCluster}
                    style={{
                        bottom: `${normalizedY}%`,
                        left: `${normalizedX}%`,
                        position: 'absolute',
                        ...
                        width: `${Math.min(150, 10 + (expandedCluster.size - 1) * 8)}px`,
                        height: `${Math.min(150, 10 + (expandedCluster.size - 1) * 8)}px`,
                        borderRadius: '50%',
                        zIndex: 20,
                        opacity: 0.5,
                    }}
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    borderRadius: '50%',
                                    cursor: 'pointer',
                                    zIndex: 30,    // Increased z-index to appear above overlay
