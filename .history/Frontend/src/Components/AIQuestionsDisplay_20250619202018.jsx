                ...
                {focusedCard !== null && (
                    <div style={{
                        ...
                        <div style={{
                            ...
                            {/* Answer content area with LARGER font size */}
                            <div style={{
                                fontSize: '18px', // Fixed large size instead of dynamic calculation
                                lineHeight: '1.5',
                                color: '#000',
                                fontFamily: "'Arial', sans-serif",
                                flex: 1,
                                overflow: 'auto', // Allow scrolling for very long text
                            }}>
                                {(() => {
