    ...
    useEffect(() => {
        ...
        const updateClusterPositions = () => {
            ...
            const styles = clusteredAnswers.map((cluster) => {
                ...
                // Calculate z-index: smaller clusters get higher z-index (appear in front)
                // Base z-index of 100, subtract cluster size so smaller = higher z-index
                const zIndex = 100 + (maxClusterSize - cluster.size);
                ...
                return {
                    ...
                    zIndex: zIndex // Smaller clusters = higher z-index = in front
                };
            });
