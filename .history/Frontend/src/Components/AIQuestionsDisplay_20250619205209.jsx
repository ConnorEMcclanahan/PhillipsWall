                        ...
                        {clusterAnswers.map((answer, index) => {
                            ...
                            return (
                                <div
                                    key={`card-hand-${index}`}
                                    onClick={() => {
                                        // If this is your card and it's clicked, dismiss the YOU label
                                        if (isYourAnswer) {
                                            setNewestAnswerId(null);
                                    ...
                                    <div style={{
                                        ...
                                        <div 
                                            ...
                                            style={{
                                                ...
                                                top: '15px',
                                                right: '15px',
                                                width: isYourAnswer ? 'auto' : '32px', // Wider for "YOU" text
                                                height: '32px',
                                                borderRadius: isYourAnswer ? '16px' : '50%', // Pill shape for "YOU"
                                                ...
                                                fontWeight: 'bold',
                                                zIndex: 2,
                                                cursor: 'pointer', // Always pointer for YOU label
                                                padding: isYourAnswer ? '0 12px' : '0', // Padding for YOU text
                                            }}
                                        >
                                            {isYourAnswer ? 'YOU' : (isFocused ? '✕' : index + 1)}
                                        </div>
                                        
                                        {/* Question - IMPROVED CENTERING */}
                                        <div style={{
                                            ...
                                            paddingRight: '20px', // MORE padding
                                            wordWrap: 'break-word',
                                            width: '100%',        // Ensure full width
                                            maxWidth: '100%',     // Prevent overflow
                                            margin: '0 auto 20px', // Center horizontally with bottom margin
                                            boxSizing: 'border-box', // Include padding in width/height calc
                                            overflowWrap: 'break-word', // Better wrapping for long words
                                            hyphens: 'auto',      // Enable hyphenation
                                        }}>
                                            {questionText}
                                        </div>
                                        
                                        {/* Answer text - better layout */}
                                        <div style={{
                                            color: '#000',
                                            ...
                                            paddingRight: '20px',  // MORE right padding
                                            boxSizing: 'border-box', // Include padding in width/height calc
                                            width: '100%',         // Ensure full width
                                            maxWidth: '100%',      // Prevent overflow
                                        }}>
