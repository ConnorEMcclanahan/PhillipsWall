...
const AIQuestionsDisplay = () => {
    ...
    // Filter clusters when data changes
    useEffect(() => {
    ...
    const renderExpandedCluster = () => {
        ...
        // Calculate softer versions of the colors
        const softOverlayColor = 'rgba(25, 25, 35, 0.85)'; // Softer dark background
        const softQuestionColor = questionColor; // Keep original color
        
        return (
            <>
                {/* Softer overlay with transition */}
                <div 
                    ...
                    style={{
                        ...
                        right: 0,
                        bottom: 0,
                        backgroundColor: softOverlayColor,
                ...
                {/* Container for expanded cluster content with scrolling */}
                <div className={styles.expandedClusterContainer} style={{
                    position: 'fixed',
                    top: '50%',
                    left: '50%',
                    transform: 'translate(-50%, -50%)',
                    ...
                    {/* Central question with reduced glow */}
                    <div
                        className={styles.centralQuestion}
                        style={{
                            backgroundColor: softQuestionColor,
                            color: 'white',
                            width: '200px',
                            height: '200px',
                            borderRadius: '50%',
                            ...
                            boxShadow: `0 0 15px ${softQuestionColor}90, inset 0 0 30px ${softQuestionColor}70`,
                            fontSize: '16px',
                            fontWeight: 'bold',
                    ...
                    {/* Answer cards in a responsive grid */}
                    <div style={{
                        width: '100%',
                        ...
                        <div style={{
                            ...
                            {clusterAnswers.length} {clusterAnswers.length === 1 ? 'answer' : 'answers'}
                        </div>
                        ...
                        <div style={{
                            ...
                            {clusterAnswers.map((answer, index) => {
                                ...
                                const estimatedLines = Math.ceil(textLength / 25);
                                const minHeight = 180;
                                const dynamicHeight = Math.max(minHeight, 100 + estimatedLines * 20);
                                const cappedHeight = Math.min(300, dynamicHeight);
                                ...
                                return (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            // Soften the color with a semi-transparent white overlay
                                            backgroundBlendMode: 'overlay',
                                        }}
                                    >
                                        {/* Thumb tack hole effect - more subtle */}
                                        <div style={{
                                            position: 'absolute',
                                            top: '10px',
                                            left: '50%',
                                        ...
                                        {/* Answer text with better contrast */}
                                        <div style={{
