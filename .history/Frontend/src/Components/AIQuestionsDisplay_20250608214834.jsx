    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.timeline} style={{
                ...
                transition: 'opacity 0.3s ease',
                pointerEvents: expandedCluster ? 'none' : 'auto',
                transform: 'scale(0.9)',  // Make timeline slightly smaller (10% smaller)
                ...
                {SEASONS.map((season, index) => (
                    ...
                    >
                        <div 
                            ...
                            style={{
                                position: 'relative',
                                top: '6px',        // Increased value to push dot down onto the line
                                width: '12px',
                                height: '12px',
                                margin: '0',
                                zIndex: 2,
                                border: activeSeason === index ? '2px solid #fff' : '1px solid rgba(255,255,255,0.5)',
                                boxSizing: 'border-box'
                            }}
                        />
                        <div className={`
                        ...
                        `}
                            style={{
                                fontSize: '12px',
                                marginTop: '10px', // Increased spacing to account for dot positioning
                                fontWeight: activeSeason === index ? '600' : '400'
                            }}
                        >
                            {season}
                        </div>
