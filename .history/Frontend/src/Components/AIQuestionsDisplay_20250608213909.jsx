                    ...
                    >
                        <div 
                            ...
                            style={{
                                ...
                                height: '10px',
                                borderRadius: '50%',
                                backgroundColor: activeSeason === index ? '#6a0dad' : '#ccc',
                                marginBottom: '4px',
                                transition: 'background-color 0.2s ease',
                                border: activeSeason === index ? '1px solid #6a0dad' : '1px solid #aaa'
                            }}
                        />
                        <div 
                            className={`${styles.timelineMonth} ${activeSeason === index ? styles.current : ''}`}
                            style={{
                                fontSize: '10px',
                                fontWeight: activeSeason === index ? 'bold' : 'normal',
                                color: activeSeason === index ? '#6a0dad' : '#555',
                                whiteSpace: 'nowrap',
                                textAlign: 'center',
