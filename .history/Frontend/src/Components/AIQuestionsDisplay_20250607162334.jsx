...
const AIQuestionsDisplay = () => {
    ...
    const renderExpandedCluster = () => {
        ...
        const radius = 180; // Larger radius for cards
            ...
            <>
                ...
                <div className={styles.expandedCluster}>
                    {clusterAnswers.map((answer, index) => {
                        ...
                        const answerText = (() => {
                            // Log the full answer object to help debug
                            console.log("Answer object structure:", answer);
                            ...
                            return answer.toString() !== '[object Object]' 
                                ? answer.toString() 
                                : `Answer ${index + 1}`;
                        })();
