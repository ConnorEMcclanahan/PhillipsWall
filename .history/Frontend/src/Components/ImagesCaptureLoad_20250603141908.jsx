...
const ImagesCaptureLoad = () => {
    ...
    const captureImage = () => {
        ...
        // Instead of going to preview, process the image directly
        processImage(imageData);
        // Note: processImage already sets scanning step to 'results' when done
    };
    ...
    const handleIncorrectScan = () => {
        // Reset and go back to camera screen
        setPreviewImage(null);
        setModelResult(null);
        setScanningStep('scanning');
        startCamera();
            ...
            <Box className={styles.scanningContainer}>
                ...
                <Box className={styles.successContainer}>
                    ...
                    <Box className={styles.scannedPostItContainer}>
                        <Box className={styles.scannedPostIt}>
