...
const AIQuestionsDisplay = () => {
    ...
    const renderExpandedCluster = () => {
        ...
        const baseRadius = 350; // Base radius that we'll adjust dynamically
        ...
        return (
            <>
                ...
                {/* Answer cards - with dynamic positioning */}
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    backgroundColor: questionColor,
                                    width: '220px',
                                    minHeight: `${Math.min(400, dynamicHeight)}px`, // Cap at 400px max height
                                    padding: '0',
                                    borderRadius: '2px',
                                    zIndex: 20,
                            ...
                            >
                                ...
                                {/* Answer text with scroll for very long content */}
                                <div style={{
                                    ...
                                    padding: '5px',
                                    overflowY: textLength > 300 ? 'auto' : 'visible', // Add scroll for very long text
    ...
    const randomShadowGrid = useMemo(() => {
        // Return empty array - no background grid
        return [];
    }, []);

   // Replace the useEffect that's currently trying to fetch the newest answer
useEffect(() => {
// Fix the fetchNewestAnswer function to handle raw number response
