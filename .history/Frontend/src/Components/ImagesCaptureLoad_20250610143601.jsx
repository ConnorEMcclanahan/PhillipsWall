    ...
    const saveToDatabase = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                // Use detected language instead of hardcoding "en"
                answer_language: modelResult.language || "en",
                
                // Add the detected color to save with the answer
                post_it_color: modelResult.color || '#feff9c'
            };
            
            console.log("Saving with AI-detected values:", {
                language: payload.answer_language,
                color: payload.post_it_color,
                x: payload.x_axis_value,
                y: payload.y_axis_value
            });
