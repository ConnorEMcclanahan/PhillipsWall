    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.timeline} style={{
                ...
                // Remove position and margin properties that were causing it to move
            }}>
                {/* Custom timeline line with limited width */}
                <div style={{
                    position: 'absolute',
                    height: '1px',
                    backgroundColor: '#ccc',
                    top: '50%',
                    left: '25px', // Start at first dot
                    right: '25px', // End at last dot
                    zIndex: 1,
                }} />
                ...
                {SEASONS.map((season, index) => (
                    ...
                    >
                        <div 
                            ...
                            `}
                            style={{ zIndex: 2 }} // Make sure dots appear above the custom line
                        />
                        <div className={`
