    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.timeline} style={{
                ...
                {/* Custom timeline line that only extends between first and last dots */}
                <div style={{
                    position: 'absolute',
                    height: '1px', // Line thickness
                    backgroundColor: '#ccc', // Line color
                    top: '50%', // Center vertically within the dots
                    left: '10px', // Start at first dot
                    right: '10px', // End at last dot
                    zIndex: 1, // Place behind the dots
                }} />
                ...
                {SEASONS.map((season, index) => (
                    <div
                        ...
                        style={{
                            ...
                            zIndex: 2, // Place above the custom line
                        }}
                    >
                        <div 
                            className={`
