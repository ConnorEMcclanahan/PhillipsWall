...
useEffect(() => {
    ...
    // Add this useEffect near other useEffects to hide "YOU" label after 20 seconds
useEffect(() => {
    // When the yourRecentAnswerId changes and is not null
    if (yourRecentAnswerId) {
        console.log("Setting timeout to hide YOU label after 20 seconds");
        
        // Set a timeout to clear the yourRecentAnswerId after 20 seconds
        const hideYouLabelTimer = setTimeout(() => {
            console.log("Clearing YOU label after timeout");
            setYourRecentAnswerId(null);
        }, 20000); // 20 seconds
        
        // Clean up the timer when component unmounts or yourRecentAnswerId changes
        return () => {
