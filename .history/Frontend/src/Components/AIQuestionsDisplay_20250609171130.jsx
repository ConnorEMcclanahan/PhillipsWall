...
const AIQuestionsDisplay = () => {
    ...
    // Add this state for tracking the user's recent submission at the top with other states
    ...
    useEffect(() => {
        ...
        const fetchLatestAnswers = async () => {
            try {
                ...
                const data = await response.json();
                setAnswersData(data);
                console.log("Answers refreshed:", new Date().toLocaleTimeString());
            } catch (error) {
                console.error("Error fetching answers:", error);
            }
        };
        ...
        fetchLatestAnswers(); // Initial fetch
        const refreshInterval = setInterval(fetchLatestAnswers, 5000);
    ...
    // Check if this is the user's cluster and remove "YOU" label if clicked
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    pointerEvents: 'auto', 
                                    cursor: 'pointer',
                                    zIndex: isYourCluster ? 11 : 10, // Higher z-index for your cluster
                            ...
                            >
                                {/* Add "YOU" indicator for the user's cluster */}
                                {isYourCluster && (
                                ...
                                {/* Rest of your existing cluster rendering */}
                                {cluster.size > 1 && (
