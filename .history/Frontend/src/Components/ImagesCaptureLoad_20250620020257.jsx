...
const ImagesCaptureLoad = () => {
    ...
    // Update the renderCamera function to add padding in landscape mode
    const renderCamera = () => (
        <Box className={`${styles.scanningContainer} ${isLandscape ? styles.landscape : ''}`}>
            <Box className={styles.scanningContent} 
                sx={isLandscape ? {
                    padding: '0 24px', // Add horizontal padding in landscape mode
                    maxWidth: '1200px', // Limit max width for very wide screens
                ...
                {isLandscape ? (
                    ...
                    <>
                        ...
                        <Box className={styles.cameraViewfinderContainer}
                            sx={{ 
                                width: '100%',
                                padding: '0 5%', // Add 5% padding on sides inside container
                        ...
                        >
                            ...
                            <Box className={styles.cameraViewfinder}
                                sx={{
                                    width: '100%',
                                    maxWidth: '900px', // Set a max width for the viewfinder
