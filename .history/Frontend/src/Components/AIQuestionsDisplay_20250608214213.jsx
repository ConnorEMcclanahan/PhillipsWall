    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.timeline} style={{
                ...
                transition: 'opacity 0.3s ease',
                pointerEvents: expandedCluster ? 'none' : 'auto',
                transform: 'scale(0.8)', // Make entire timeline 20% smaller
                transformOrigin: 'center bottom', // Scale from bottom center
                marginBottom: '-10px', // Adjust position to compensate for scaling
            }}>
                {SEASONS.map((season, index) => (
                    ...
                    >
                        <div 
                            ...
                            `}
                            style={{
                                transform: 'scale(0.85)', // Make points slightly smaller
                            }}
                        />
                        <div className={`
