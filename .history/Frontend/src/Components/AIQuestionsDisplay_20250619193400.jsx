...
const AIQuestionsDisplay = () => {
    ...
    // Card hand interaction state - MOVE THESE HERE instead of inside the render function
    ...
    // Handler for card click - moved outside renderExpandedCluster
    ...
    // Render expanded cluster view - using state from the component level
