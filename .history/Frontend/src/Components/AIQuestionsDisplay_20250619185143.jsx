            ...
            <>
                ...
                <div 
                    ...
                    style={{
                        ...
                        right: 0,
                        bottom: 0,
                        backgroundColor: 'rgba(25, 25, 35, 0.75)', // Softer dark overlay
                ...
                {/* Central question with black text and reduced glow */}
                <div
                ...
                {/* Answer cards - same layout but with better text positioning */}
                    ...
                    {clusterAnswers.map((answer, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Answer text with proper vertical positioning */}
                                <div style={{
                                    ...
                                    position: 'relative',
                                    zIndex: 2,
                                    margin: '30px 10px 10px 10px', // INCREASED top margin to 30px
                                    padding: '5px',
