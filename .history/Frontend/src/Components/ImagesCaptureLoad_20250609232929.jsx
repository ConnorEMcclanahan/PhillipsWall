...
// Replace your current API_BASE with this more robust version
const API_BASE = (() => {
    // Check if using localtunnel (contains "loca.lt")
    if (window.location.hostname.includes('loca.lt')) {
        // Assuming backend uses a consistent subdomain pattern
        return window.location.hostname.replace('frontend', 'backend');
    }
    ...
    // Production
        ...
        return `http://${window.location.hostname.replace('3000', '5000')}`;
    }
})();
