            ...
            <>
                ...
                <div className={styles.expandedCluster}>
                    {clusterAnswers.map((answer, index) => {
                        ...
                        // Update the answer card styling to include lines and handwritten text appearance
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    // Horizontal lined paper styling
                                    backgroundImage: `
                                        linear-gradient(transparent 0px, transparent 18px, rgba(255,255,255,0.4) 18px, rgba(255,255,255,0.4) 19px),
                                        linear-gradient(90deg, transparent 0px, transparent 20px, rgba(255,255,255,0.2) 20px, rgba(255,255,255,0.2) 21px)
                                    `,
                            ...
                            >
                                <div style={{
                                    fontFamily: "'Comic Sans MS', cursive, sans-serif", // Handwriting-like font
                                    fontSize: '15px',
                                    lineHeight: '20px', // Match the line height of our background lines
                                    textShadow: '0 0 1px rgba(0,0,0,0.2)',
                                    width: '100%',
                                    padding: '0 5px',
                                    transform: `rotate(${Math.random() * 2 - 1}deg)`, // Slight random rotation for text
                                    fontStyle: 'italic',
                                    letterSpacing: '0.5px'
                                }}>
                                    {answerText}
                ...
                <div className={styles.answersGrid}>
                    ...
                    {clusteredAnswers.map((cluster, index) => (    
                        <div
                            ...
                            style={{
                                ...bubbleStyles[index],
                                // Make sure ALL bubbles are visible and interactive in normal state
                                opacity: 1,
                                pointerEvents: 'auto', 
                                cursor: 'pointer',
