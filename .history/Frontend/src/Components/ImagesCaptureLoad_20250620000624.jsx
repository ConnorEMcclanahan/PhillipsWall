...
const ImagesCaptureLoad = () => {
    ...
    const [questionColorMap, setQuestionColorMap] = useState({});
    ...
    // Create color map from questions data
    useEffect(() => {
        const map = {};
                ...
                <Box className={styles.successContainer}>
                    ...
                    <Box className={styles.scannedPostItContainer}>
                        <Box 
                            ...
                            style={{ 
                                backgroundColor: getQuestionColor(parseInt(modelResult.question_id))
                            }}
                        >
                            {console.log("POST-IT COLOR FROM MODEL:", modelResult.question_id, getQuestionColor(parseInt(modelResult.question_id)))}
