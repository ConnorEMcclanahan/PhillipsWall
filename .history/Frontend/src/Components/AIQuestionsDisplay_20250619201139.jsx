                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        {clusterAnswers.map((answer, index) => {
                            ...
                            const fontSize = determineOptimalFontSize(
                                answerText,
                                260, // Available width
                                260  // Available height accounting for question and margins
                            );
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        ...
                                        transform: isFocused
                                            ? 'translateY(-45%) translateX(0) scale(1.1) rotate(0deg)'
                                            : otherCardIsFocused 
                                                ? `translateX(${angle * 28}px) translateY(${isHovered ? -10 : 0}px) rotate(${angle}deg) scale(0.85) translateY(40px)` 
                                        ...
                                        cursor: 'pointer',
                                        overflow: 'hidden', // Changed from 'auto' to 'hidden'
                                        opacity: otherCardIsFocused ? 0.6 : 1,
                                        display: 'flex',
                                        flexDirection: 'column',
                                    }}
                                >
                                    ...
                                    <div style={{
                                        ...
                                        {/* Thumbtack and Card number - unchanged */}
                                        <div style={{
                                            position: 'absolute',
                                            top: '10px',
                                            left: '50%',
                                        ...
                                        <div style={{
                                            ...
                                            {/* Full answer text with dynamic sizing */}
                                            <div style={{
                                                color: '#000',
                                                fontSize: fontSize,
                                                lineHeight: '1.3',
