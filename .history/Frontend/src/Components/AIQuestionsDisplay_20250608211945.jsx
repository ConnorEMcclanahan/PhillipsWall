...
const AIQuestionsDisplay = () => {
    ...
    const filterClustersBySeason = (seasonIndex) => {
        ...
        const filtered = clusteredAnswers.filter(cluster => {
            // Check if ANY answer in the cluster belongs to the selected season
            for (const answer of cluster.answers) {
                // Most likely field is scan_date based on your description
                ...
                if (dateField) {
                    try {
                        ...
                        // If ANY answer belongs to this season, include the cluster
                        if (parsed === seasonIndex) {
                            return true;
                        }
                        // Otherwise continue checking other answers
                    } catch (e) {
            ...
            // If no valid date found in ANY answer, don't include this cluster
            return false;
        });
