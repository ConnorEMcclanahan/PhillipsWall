        ...
        return (
            <>
                ...
                <div style={{
                    ...
                    width: '95%',
                    height: '500px',  // MUCH TALLER for bigger cards
                    zIndex: 1600,
                    display: 'flex',
                    ...
                    <div style={{
                        ...
                        {clusterAnswers.map((answer, index) => {
                            ...
                            const maxAngle = Math.min(35, totalCards * 2.5); // Reduced angle for larger cards
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        position: 'absolute',
                                        width: isFocused ? '450px' : '350px', // MUCH WIDER cards
                                        height: isFocused ? '550px' : '450px', // MUCH TALLER cards
                                        backgroundColor: questionColor,
                                        borderRadius: '12px', // Larger radius for bigger cards
                                        boxShadow: isFocused
                                        ...
                                        transform: isFocused
                                            ? 'translateY(-150px) translateX(0) rotate(0deg) scale(1.1)' // Move up higher when focused
                                ...
                                >
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            top: '15px',
                                            right: '15px',
                                            width: '32px', // Larger number badge
                                            height: '32px',
                                            borderRadius: '50%',
                                        ...
                                        {/* Content container */}
                                        <div style={{
                                            marginTop: '50px', // More space for thumbtack
                                            padding: '0 25px 20px',
                                            display: 'flex',
                                            flexDirection: 'column',
                                            ...
                                            {/* Question on card - LARGER */}
                                            <div style={{
                                                fontSize: isFocused ? '22px' : '18px', // LARGER text
                                                fontWeight: 'bold',
                                                color: '#000',
                                                textAlign: 'center',
                                                marginBottom: '20px',
                                            ...
                                            {/* Full answer text with LARGER font */}
                                            <div style={{
                                                color: '#000',
                                                fontSize: isFocused ? '18px' : '16px', // LARGER text
                                                lineHeight: '1.5',
                                                textAlign: 'left',
                                                overflow: 'auto',
                                                flex: 1,
