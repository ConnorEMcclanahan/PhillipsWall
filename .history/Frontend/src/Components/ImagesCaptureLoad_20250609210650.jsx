        ...
        try {
            ...
            const response = await fetch(`${API_BASE}/save-answer`, {
                ...
                body: JSON.stringify({
                    ...
                    x_axis_value: Math.random(), // Optional: Random position if your backend needs it
                    y_axis_value: Math.random(), // Optional: Random position if your backend needs it
                }),
            });
            ...
            if (result.success || result.id) {
                // Store the answer ID in localStorage so it can be highlighted on the wall
                if (result.id) {
            ...
            alert('Error adding to wall. Please try again.');
        } finally {
            setIsLoading(false);
        }
    };
