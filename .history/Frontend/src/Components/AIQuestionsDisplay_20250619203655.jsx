                        ...
                        {clusterAnswers.map((answer, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        position: 'absolute',
                                        width: isFocused ? '600px' : '450px', // INCREASED widths
                                ...
                                >
                                    ...
                                    <div style={{
                                        ...
                                        display: 'flex',
                                        flexDirection: 'column',
                                        padding: '50px 30px 20px', // INCREASED horizontal padding from 25px to 30px
                                    }}>
                                        {/* Thumbtack */}
                                        <div style={{
                                            position: 'absolute',
                                        ...
                                        {/* Question - Directly in the main container */}
                                        <div style={{
                                        ...
                                        {/* Answer text - with better text wrapping */}
                                        <div style={{
                                            color: '#000',
                                            ...
                                            flex: 1,
                                            wordWrap: 'break-word', // Ensure text wraps properly
                                            paddingRight: '15px', // Added more padding on the right
                                        }}>
                                            {answerText.split('\n').map((line, i) => (
                                                <div key={i} style={{ 
                                                    marginBottom: '10px',
