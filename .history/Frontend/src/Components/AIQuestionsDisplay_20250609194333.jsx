...
const AIQuestionsDisplay = () => {
    ...
    // Filter clusters by season - MODIFIED to only use real dates
    const filterClustersBySeason = (seasonIndex) => {
        if (!clusteredAnswers.length) return;
        
        // Only filter by real dates - no fallback distribution
        ...
        // Set filtered clusters directly - no minimum threshold check
