                ...
                {SEASONS.map((season, index) => (
                    ...
                    >
                        <div 
                            ...
                            style={{
                                position: 'relative',
                                top: '1px',        // Fine-tune to ensure dot sits exactly on the line
                                width: '12px',     // Slightly smaller dot
                                height: '12px',    // Slightly smaller dot  
                                margin: '0',
                                zIndex: 2          // Ensure dot appears above line
                            }}
                        />
                        <div className={`
                        ...
                        `}
                            style={{
                                ...
                                marginTop: '6px',  // Consistent spacing
