                        ...
                        {clusterAnswers.map((answer, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        position: 'absolute',
                                        width: isFocused ? '550px' : '400px', // WIDER cards (was 450px/350px)
                                ...
                                >
                                    ...
                                    <div style={{
                                        ...
                                        display: 'flex',
                                        flexDirection: 'column',
                                        padding: '50px 30px 20px', // Fixed padding to prevent text movement
                                    }}>
                                        {/* Thumbtack */}
                                        <div style={{
                                            position: 'absolute',
                                        ...
                                        {/* Card number/close button - now shows X when focused */}
                                        <div 
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                if (isFocused) {
                                        ...
                                        <div style={{
                                            ...
                                            marginBottom: '20px',
                                            paddingBottom: '10px',
                                            // No relative margins or padding that would cause text movement
                                        }}>
                                            {questionText}
                                        </div>
