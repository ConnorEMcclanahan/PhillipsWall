...
const AIQuestionsDisplay = () => {
    ...
    const renderExpandedCluster = () => {
        ...
        // DELETE THESE TWO LINES - they duplicate the hooks at the component level
        // const [focusedCard, setFocusedCard] = useState(null);  // DELETE THIS
        // const [hoveredCard, setHoveredCard] = useState(null);  // DELETE THIS

        // Keep the handleCardClick function, but remove the useState calls above
