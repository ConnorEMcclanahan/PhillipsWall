                        ...
                        {clusterAnswers.map((answer, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        position: 'absolute',
                                        width: isFocused ? '550px' : '400px', // Wider cards
                                ...
                                >
                                    ...
                                    <div style={{
                                        ...
                                        display: 'flex',
                                        flexDirection: 'column',
                                        padding: '50px 25px 20px', // Moved padding here to avoid nested scrollable divs
                                    }}>
                                        {/* Thumbtack */}
                                        <div style={{
                                            position: 'absolute',
                                        ...
                                        {/* Answer text - Directly in the main container */}
                                        <div style={{
                                            color: '#000',
