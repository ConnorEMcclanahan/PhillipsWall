    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.timeline} style={{
                ...
                transition: 'opacity 0.3s ease',
                pointerEvents: expandedCluster ? 'none' : 'auto',
                transform: 'scale(0.85)', // Keep the scale down to 85%
            }}>
                {/* Add an overlay element that hides just the extended ends of the line */}
                <div style={{
                    position: 'absolute',
                    top: '50%',
                    left: '0',
                ...
                {/* Hide the line on the right side too */}
                <div style={{
                    position: 'absolute',
                    top: '50%',
                    right: '0',
                ...
                {SEASONS.map((season, index) => (
                    <div
                        ...
                        style={{ zIndex: 3 }} // Make sure dots appear on top
                    >
                        <div 
                            className={`
