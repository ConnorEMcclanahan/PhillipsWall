            ...
            <Box className={styles.scanningContainer}>
                ...
                <Box className={styles.successContainer}>
                    ...
                    <Box className={styles.scannedPostItContainer}>
                        ...
                        {/* Add circular preview to match the AI Wall */}
                        <Box sx={{
                            display: 'flex',
                            ...
                            <Box sx={{
                                ...
                                alignItems: 'center',
                                position: 'relative',
                                border: '3px solid black',  // Add the "YOU" border
