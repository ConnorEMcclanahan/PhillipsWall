...
const ImagesCaptureLoad = () => {
    ...
    const getQuestionColor = useCallback((questionId) => {
        ...
        return questionColorMap[questionId] || 
               questionColorMap[String(questionId)] || 
               questionColorMap[Number(questionId)] || 
               '#7EDDDE';
    }, [questionColorMap]);
                ...
                <Box className={styles.successContainer}>
                    ...
                    <Box className={styles.scannedPostItContainer}>
                        <Box 
                            ...
                            style={{ 
                                backgroundColor: getQuestionColor(parseInt(modelResult.question_id) || 1)
                            }}
                        >
