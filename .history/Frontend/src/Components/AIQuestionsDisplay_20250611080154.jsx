...
const AIQuestionsDisplay = () => {
    ...
    const renderExpandedCluster = () => {
        ...
        const radius = 400; // Increased radius to spread cards out more
            ...
            <>
                ...
                <div
                    ...
                    style={{
                        ...
                        textAlign: 'center',
                        zIndex: 25,
                        boxShadow: `0 0 30px ${questionColor}`,
                        ...
                        return (
                            <div
                                ...
                                style={{
                                    ...
                                    // Removed the backgroundImage with lines
                                }}
                            >
                                <div style={{
                                    fontFamily: "'Arial', sans-serif", // Changed from Comic Sans to a cleaner font
                                    fontSize: '14px',
                                    lineHeight: '20px',
                                    width: '100%',
                                    height: '100%',
