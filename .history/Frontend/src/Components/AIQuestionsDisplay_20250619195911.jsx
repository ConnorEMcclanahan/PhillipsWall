    ...
    const renderExpandedCluster = () => {
        ...
        return (
            <>
                ...
                {/* Card hand at bottom - larger cards with full text */}
                <div style={{
                    position: 'fixed',
                    bottom: '5%',
                    left: '50%',
                    transform: 'translateX(-50%)',
                    width: '95%',
                    height: '280px',  // Increased height for larger cards
                    zIndex: 1600,
                    display: 'flex',
                    justifyContent: 'center',
                    perspective: '1000px',
                                ...
                                <div
                                    ...
                                    style={{
                                        ...
                                        transform: isFocused
                                            ...
                                            : `translateX(${angle * 25}px) translateY(${isHovered ? -30 : 0}px) rotate(${angle}deg)`,
                                        transition: 'all 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275)',
                                        transformOrigin: 'bottom center',
                                        zIndex: isHovered ? 100 + index : index,
                                        cursor: 'pointer',
                                        overflow: 'auto', // Changed from 'hidden' to allow scrolling
                                        opacity: 1, // Changed from 0.9 to be fully opaque
                                        display: 'flex',
                                        flexDirection: 'column',
                                    }}
                                >
                                    ...
                                    <div style={{
                                        ...
                                        {/* Content container - now starts below the thumbtack */}
                                        <div style={{
                                            marginTop: '30px', // Space for thumbtack
                                            padding: '0 12px',
                                            display: 'flex',
                                            flexDirection: 'column',
                                            flex: 1,
                                            ...
                                            <div style={{
                                                ...
                                                color: '#000',
                                                textAlign: 'center',
                                                marginBottom: '10px', // Space between question and answer
                                                // No border-bottom now
                                            }}>
                                                {questionText}
                                            </div>
                                            ...
                                            <div style={{
                                                ...
                                                lineHeight: '1.4',
                                                textAlign: 'left',
                                                // Removed WebkitLineClamp to allow full text
                                            }}>
                                                {answerText}
                                            </div>
                                        </div>
