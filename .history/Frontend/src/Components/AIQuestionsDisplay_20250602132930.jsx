...
const AIQuestionsDisplay = () => {
    ...
    // Keep ONLY this cluster positioning useEffect and fix it:
    useEffect(() => {
        ...
        const updateClusterPositions = () => {
            const styles = clusteredAnswers.map((cluster) => {
                ...
                // Simple z-index: smaller clusters = higher z-index
                const zIndex = 1000 - (cluster.size * 10);
            ...
            setBubbleStyles(styles); // Only set this once
        };

        updateClusterPositions();
        // REMOVE THE INTERVAL - this was causing the flying
        ...
        <div className={styles.container}>
            <div className={styles.answersLayer}>
                <div className={styles.answersGrid}>
                    {/* Only render clustered answers - no individual bubbles */}
