                ...
                <div className={styles.answersGrid}>
                    {(filteredClusters.length > 0 ? filteredClusters : []).map((cluster, index) => {
                        ...
                        const newestAnswer = [...cluster.answers].sort((a, b) => {
                            const dateA = new Date(a.answer_date || a.created_at || a.date || 0).getTime();
                            const dateB = new Date(b.answer_date || b.created_at || b.date || 0).getTime();
                            console.log(a.answer_date); // Sort from newest to oldest
                            return dateB - dateA;
                        })[0];
