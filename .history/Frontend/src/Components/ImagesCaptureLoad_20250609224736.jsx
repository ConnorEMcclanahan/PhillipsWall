...
const ImagesCaptureLoad = () => {
    ...
    const processImage = async (imageData) => {
        ...
        try {
            ...
            // Ensure image data isn't too large (might cause issues on tablet)
            const compressedImage = imageData.length > 1000000 
                ? imageData.replace('data:image/jpeg;base64,', '').substring(0, 900000)
                : imageData;
